				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+024) 555-555-555" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+024) 555-555-555</a>
								</li>
							</ul>
						</div>
							...
							<ul>
								...
								<li class="menu-item lang-menu menu-item-has-children parent">
									...
									<ul class="submenu lang" >
										<li class="menu-item" ><a title="hungary" href="#"><span class="img label-before"><img src="{{ asset('assets/images/lang-viet.png')}}" alt="lang-viet"></span>VietNam</a></li>
										<li class="menu-item" ><a title="german" href="#"><span class="img label-before"><img src="{{ asset('assets/images/lang-rus.png')}}" alt="lang-rus" ></span>Russian</a></li>
								...
								<li class="menu-item menu-item-has-children parent" >
									...
									<ul class="submenu curency" >
										...
										<li class="menu-item" >
											<a title="Dollar (USD)" href="#">VietNamDong (VND)</a>
										</li>
									</ul>
								</li>
									@if(Route::has('login'))
