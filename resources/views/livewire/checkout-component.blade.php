                    ...
                    <div class="wrap-address-billing">
                        ...
                        <div class="billing-address">
                            ...
                            <p class="row-in-form">
                                ...
                                <input  type="number" name="phone" value="" placeholder="9 digits format"  wire:model="mobile">
                ...
                <div class="col-md-12">
                    <div class="wrap-address-billing">
                        ...
                        <div class="billing-address">
                            ...
                            <p class="row-in-form">
                                <label for="phone">Phone number<span>*</span></label>
                                <input  type="number" name="phone" value="" placeholder="9 digits format" wire:model="s_mobile">
                            ...
                            <p class="row-in-form">
                                <label for="city">Town / City<span>*</span></label>
                                <input  type="text" name="city" value="" placeholder="Town/City name" wire:model="s_city">
                ...
                <div class="summary-item payment-method">
                    ...
                    <div class="wrap-address-billing">
                        ...
                        <p class="row-in-form">
                            ...
                            <input  type="number" name="exp-year" value="" placeholder="YY" wire:model="exp_year">
                    ...
                    <div class="choose-payment-methods">
                        ...
                        <label class="payment-method">
                            ...
                            <span class="payment-desc">There are many variations available</span>
                        </label>
                        <label class="payment-method">
