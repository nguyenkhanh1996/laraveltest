                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="col-md-4 control-label">Subtitle</label>
                                <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label for="col-md-4 control-label">Price</label>
                                    <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label for="col-md-4 control-label">Link</label>
                                        <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label for="col-md-4 control-label">Image</label>
                                            <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label for="col-md-4 control-label">Status</label>
                                            <div class="col-md-4">
